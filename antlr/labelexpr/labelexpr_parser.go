...
var parserATN = []uint16{
	...
	2, 3, 6, 5, 2, 4, 6, 2, 4, 3, 2, 12, 13, 3, 2, 10, 11, 2, 48, 2, 9, 3,
...
func NewLabelExprParser(input antlr.TokenStream) *LabelExprParser {
	this := new(LabelExprParser)
	...
	this.GrammarFileName = "LabelExpr.g4"

	return this
}

// LabelExprParser tokens.
const (
	LabelExprParserEOF     = antlr.TokenEOF
	LabelExprParserT__0    = 1
	LabelExprParserT__1    = 2
	LabelExprParserT__2    = 3
	LabelExprParserID      = 4
	LabelExprParserINT     = 5
	LabelExprParserNEWLINE = 6
	LabelExprParserWS      = 7
	LabelExprParserADD     = 8
	LabelExprParserSUB     = 9
	LabelExprParserMUL     = 10
	LabelExprParserDIV     = 11
)

// LabelExprParser rules.
const (
	LabelExprParserRULE_prog = 0
	LabelExprParserRULE_stat = 1
	LabelExprParserRULE_expr = 2
)
...
func NewEmptyProgContext() *ProgContext {
	...
	p.RuleIndex = LabelExprParserRULE_prog
	return p
}
...
func (s *ProgContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(LabelExprListener); ok {
...
func (p *LabelExprParser) Prog() (localctx IProgContext) {
	localctx = NewProgContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 0, LabelExprParserRULE_prog)
	var _la int
	...
	for ok := true; ok; ok = (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<LabelExprParserT__1)|(1<<LabelExprParserID)|(1<<LabelExprParserINT)|(1<<LabelExprParserNEWLINE))) != 0) {
		{
			p.SetState(6)
			p.Stat()
		}
...
func NewEmptyStatContext() *StatContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = LabelExprParserRULE_stat
	return p
}
...
func (s *BlankContext) NEWLINE() antlr.TerminalNode {
	return s.GetToken(LabelExprParserNEWLINE, 0)
}
...
func (s *AssignContext) ID() antlr.TerminalNode {
	return s.GetToken(LabelExprParserID, 0)
}
...
func (p *LabelExprParser) Stat() (localctx IStatContext) {
	localctx = NewStatContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 2, LabelExprParserRULE_stat)
	...
	case 1:
		...
		{
			p.SetState(12)
			p.Match(LabelExprParserNEWLINE)
		}
	...
	case 2:
		...
		{
			p.SetState(14)
			p.Match(LabelExprParserID)
		}
		{
			p.SetState(15)
			p.Match(LabelExprParserT__0)
		}
		{
			p.SetState(16)
			p.expr(0)
...
func NewEmptyExprContext() *ExprContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = LabelExprParserRULE_expr
	return p
}
...
func (s *MulDivContext) MUL() antlr.TerminalNode {
	return s.GetToken(LabelExprParserMUL, 0)
}

func (s *MulDivContext) DIV() antlr.TerminalNode {
	return s.GetToken(LabelExprParserDIV, 0)
}
...
func (s *AddSubContext) ADD() antlr.TerminalNode {
	return s.GetToken(LabelExprParserADD, 0)
}

func (s *AddSubContext) SUB() antlr.TerminalNode {
	return s.GetToken(LabelExprParserSUB, 0)
}
...
func (s *IntContext) INT() antlr.TerminalNode {
	return s.GetToken(LabelExprParserINT, 0)
}
...
func (p *LabelExprParser) Expr() (localctx IExprContext) {
	return p.expr(0)
}

func (p *LabelExprParser) expr(_p int) (localctx IExprContext) {
	...
	_startState := 4
	p.EnterRecursionRule(localctx, 4, LabelExprParserRULE_expr, _p)
	var _la int
	...
	case LabelExprParserINT:
		...
		{
			p.SetState(23)
			p.Match(LabelExprParserINT)
		}

	case LabelExprParserID:
	...
	case LabelExprParserT__1:
		localctx = NewParensContext(p, localctx)
		p.SetParserRuleContext(localctx)
		_prevctx = localctx
		{
			p.SetState(25)
			p.Match(LabelExprParserT__1)
		}
		{
			p.SetState(26)
			p.expr(0)
	...
	for _alt != 2 && _alt != antlr.ATNInvalidAltNumber {
		if _alt == 1 {
			...
			case 1:
				...
				p.PushNewRecursionContext(localctx, _startState, LabelExprParserRULE_expr)
				p.SetState(31)
				...
				}
				{
					...
					if !(_la == LabelExprParserMUL || _la == LabelExprParserDIV) {
			...
			case 2:
				...
				}
				{
					...
					if !(_la == LabelExprParserADD || _la == LabelExprParserSUB) {
						var _ri = p.GetErrorHandler().RecoverInline(p)
...
func (p *LabelExprParser) Sempred(localctx antlr.RuleContext, ruleIndex, predIndex int) bool {
	switch ruleIndex {
	case 2:
...
func (p *LabelExprParser) Expr_Sempred(localctx antlr.RuleContext, predIndex int) bool {
	switch predIndex {
	case 0:
